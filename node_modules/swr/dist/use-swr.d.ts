...
export declare const useSWRHandler: <Data = any, Error_1 = any>(_key: Key, fn: ((args_0: string) => import("./types").FetcherResponse<Data>) | ((args_0: any, ...args_1: unknown[]) => import("./types").FetcherResponse<Data>) | ((args_0: Record<any, any>) => import("./types").FetcherResponse<Data>) | ((args_0: string | [any, ...unknown[]] | readonly [any, ...unknown[]] | Record<any, any>) => import("./types").FetcherResponse<Data>) | null, config: import("./types").InternalConfiguration & import("./types").PublicConfiguration<any, any, import("./types").BareFetcher<unknown>> & Partial<import("./types").PublicConfiguration<Data, Error_1, import("./types").BareFetcher<any>>>) => SWRResponse<Data, Error_1>;
