...
var schemaToDescriptionsItem = function schemaToDescriptionsItem(items, entity, action, editableUtils) {
  ...
  var children = items === null || items === void 0 ? void 0 : (_items$map = items.map) === null || _items$map === void 0 ? void 0 : _items$map.call(items, function (item, index) {
    ...
    var titleDom = (0, _proUtils.genCopyable)(title, item, text); //  dataIndex 无所谓是否存在
    ...
    var field = /*#__PURE__*/_react.default.createElement(_descriptions.default.Item, (0, _extends2.default)({}, restItem, {
      ...
      label: (titleDom || restItem.label || restItem.tooltip || restItem.tip) && /*#__PURE__*/_react.default.createElement(_proUtils.LabelIconTip, {
