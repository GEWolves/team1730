...
var _useMountMergeState3 = _interopRequireDefault(require("../useMountMergeState"));
...
function SaveEditableAction(_ref) {
  ...
  var _useMountMergeState = (0, _useMountMergeState3.default)(false),
...
function useEditableArray(props) {
  ...
  var actionRender = function actionRender(row, form) {
    ...
    var config = {
      ...
      onCancel: function () {
        var _onCancel = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee7(recordKey, editRow, originRow, newLine) {
          var _props$onCancel;
