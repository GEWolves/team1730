...
const builtinPreviewerTransformer = ({
  ...
  let files = {};
  let dependencies = {}; // collect third-party dependencies and locale file dependencies for demo
  ...
  return {
    ...
    previewerProps: {
      sources: _objectSpread({
        _: {
          [node.properties.lang]: isExternalDemo ? (0, _utils.encodeHoistImport)(node.properties.filePath) : _.default.code(node.properties.source).content
        }
