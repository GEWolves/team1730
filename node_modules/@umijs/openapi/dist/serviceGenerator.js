        ...
        Object.keys(this.openAPIData.paths || {}).forEach((p) => {
            ...
            ['get', 'put', 'post', 'delete', 'patch'].forEach((method) => {
                ...
                if (props.length > 0) {
                    data && data.push([
                        {
                            typeName: resolveTypeName(`${namespace}${(_d = (_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.hook) === null || _b === void 0 ? void 0 : _b.customFunctionName) === null || _c === void 0 ? void 0 : _c.call(_b, operationObject)) !== null && _d !== void 0 ? _d : operationObject.operationId}Params`),
